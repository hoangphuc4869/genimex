<x-admin-layout>
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6  main-admin-home">
            ...
            <div class="w-full mt-12">
                ...
                <form method="POST" action="{{route('admin.update_homepage')}}" class="" enctype="multipart/form-data">
                    ...
                    {{-- <input type="file" multiple name="images_block1[]" id=""> --}}
                    <button type="submit" class="px-4 py-1 text-white font-light tracking-wider bg-blue-600 rounded">Lưu</button>
                </form>
            </div>
        </main>
    </div>
