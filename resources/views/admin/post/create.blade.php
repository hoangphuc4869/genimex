        ...
        <main class="w-full flex-grow p-6">
            ...
            <div class="w-full mt-12">
                ...
                <div class="mb-1">
                    ...
                    dark:focus:border-blue-500" id="selectType" name="status">
