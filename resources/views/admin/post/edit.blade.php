<x-admin-layout>
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="w-full text-3xl text-black pb-6">Edit Post</h1>
            ...
            <div class="w-full mt-12">
                ...
                <div class="mb-1">
                   ...
                   <div class="translation">
                    ...
                    <input type="text" value="{{!empty($transcontents->translated_title) ? $transcontents->translated_title : "" }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="trans_column[title]" id="en-title" placeholder="English Title">
                   </div>
                </div>
                <div class="mb-1">
                ...
                <div class="mb-2">
                  ...
                  <div class="translation">
                      <label class="block text-sm text-gray-600" for="message">Translation</label>
                    <textarea id="summernote2" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 translatedContent" name="trans_column[content]">{{!empty($transcontents->translated_content) ? $transcontents->translated_content : "" }}</textarea>
                  </div>
                </div>
